...
static const char *const prompt_variants[] = {
    "Можна яшчэ разок, Мішаня, крані капялюшык!",
    "Міша, калі душа просіць цуду, чапні грыбок!",
    "Мішунь, давай яшчэ знак ад зорак, крані носік!",
    "Мішаня, круцім удачу нанова, дакраніся да пыпкі!",
    "Міша, калі хочаш працяг, смела тронь капялюшык!",
    "Мішунь, яшчэ адно жаданне? Чапні пупку!",
    "Мішаня, давай другі раўнд чараў, крані грыбок!",
    "Міша, прыборчык не стаміўся. Тронь носік!",
    "Мішунь, лёс на сувязі, толькі чапні капялюшык!",
    "Мішаня, можна яшчэ крышачку магіі. Крані пыпку!",
    "Міша, калі настрой агонь, дакраніся да грыбка!",
    "Мішунь, яшчэ адна спроба на шчасце, тронь макушку!",
    "Мішаня, правер, што нашапталі зоркі. Чапні носік!",
    "Міша, ну што, па яшчэ адзін сюрпрыз? Крані капялюшык!",
    "Мішунь, лаві новы адказ, толькі дакраніся да пупкі!",
    "Мішаня, жаданні не скончыліся. Чапні пыпку!",
    "Міша, давай яшчэ раз варухнём сусвет. Тронь грыбок!",
    "Мішунь, калі мала чараў, крані капялюшык пальчыкам!",
    "Мішаня, час для новай варажбы. Дакраніся да носіка!",
    "Міша, яшчэ хваліначку магіі? Чапні грыбок!",
};
...
static void draw_spinner(uint32_t elapsed_ms) {
    static const char *const captions[] = {"Думаю...", "Варушу зорачкі...", "Лаўлю знак..."};
    display_centered(7, captions[(elapsed_ms / 420) % 3]);
    display_spinner(elapsed_ms / 100);
    display_centered(48, "Мішуне, хвілінку!");
}
